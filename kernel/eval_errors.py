...
KERNEL_EVAL_CODES: frozenset[str] = frozenset({
    ...
    "UNKNOWN_PATTERN_MODE",
    "UNKNOWN_PATTERN_TERMINAL",
    "UNKNOWN_STAGE_QUANTIFIER",
    "PATTERN_HAS_NO_STAGES",
    "PATTERN_SPAN_NOT_DECLARED",
    "PATTERN_UNTIL_NEEDS_A_STOP_STAGE",
    "PATTERN_MIN_MATCHES_INVALID",
    "INCOMPATIBLE_STAGE_QUANTIFIER",
    "STAGE_COUNT_MUST_BE_POSITIVE",
    "EVAL_SEQUENCE_SEARCH_EXCEEDED",
    "EVAL_SEQUENCE_MATCHES_EXCEEDED",
    "EVAL_ITERATION_NOT_CONVERGED",
    "EVAL_ITERATION_STEP_EXCEEDED",
    "ITERATE_STEP_NOT_A_TRANSFORM",
    "PACKAGE_UNIT_SCHEMA_UNKNOWN",
